        ...
        <main ref={printRef} className="mx-auto max-w-4xl px-4 py-8 space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm print-avoid-break">
            ...
            <div className="hidden print:flex items-center gap-2 mb-4 pb-4 border-b border-slate-200">
              ...
              <span className="font-bold text-sm text-slate-700">InspectReady — Inspection Readiness Assessment</span>
            </div>

            <p className="text-xs font-semibold uppercase tracking-wider text-teal-600 mb-1">InspectReady</p>
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm text-amber-800 print-avoid-break">
            ...
            <p className="leading-relaxed text-xs">
              This report was generated by InspectReady as a practice and professional development tool. It does not constitute an official Ofsted inspection, compliance certification, or legal advice. Scores and feedback are AI-generated based on your answers only and should be used for self-reflection and preparation purposes. InspectReady is not affiliated with Ofsted.
            </p>
          </div>

          {/* Footer */}
          <p className="text-xs text-slate-400 leading-relaxed">
            © {new Date().getFullYear()} InspectReady — inspectready.co.uk — hello@inspectready.co.uk
          </p>
        </main>

        {/* Print-only page footer */}
        <footer className="print-footer print-hide">
          InspectReady — Inspection Readiness Assessment Report — inspectready.co.uk
        </footer>
      </div>
    </>
  );
